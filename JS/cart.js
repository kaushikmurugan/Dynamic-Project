// import { cartData } from "./indian cuisine";
...
// const localcartPull = foodItem.filter((items) => items.cuisine == "IC");
// console.log(localcartPull);

let example = localcartPull.map((items)=>{
return `item id ${items.id} item name ${items.foodName}`
});
